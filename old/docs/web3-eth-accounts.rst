...
The ``meterify.eth.accounts`` contains functions to generate Ethereum accounts and sign transactions and data.
...
1. ``account`` - ``String|Object``: A private key or account object created with :ref:`meterify.eth.accounts.create() <accounts-create>`.
